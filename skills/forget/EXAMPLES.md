...
Response has 4 results all with `sessionId: c98f1100`. Show all four, get a yes, then pass every id:
...
> Nothing deleted. The 4 memories from session `c98f110` are still there.
