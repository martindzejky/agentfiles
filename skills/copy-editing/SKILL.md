...
If `MARKETING.md` exists, read it before editing. Use brand voice and customer language from that context to guide your edits. Also check out `BRAND.md` if it exists.
