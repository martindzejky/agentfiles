...
Memories carry content, concepts, files, importance, and timestamps, grouped into sessions and optionally linked to commits. Capture, compress, consolidate, and forget keep the store useful over time instead of letting it grow forever.

## Ports

REST anchors at 3111. Streams = N+1 (3112), viewer = N+2 (3113), engine = N+46023 (49134). `--instance N` shifts the whole block by N\*100.
...
- remember / recall for explicit capture and retrieval via MCP in Cursor, Codex, and similar agents.
