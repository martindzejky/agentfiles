...
agentmemory exposes its full capability set as MCP tools. This skill is the index: which tool to reach for, and where to find exact parameters.
...
Full tool table with parameters and the core-set marking lives in REFERENCE.md, generated from source so it stays in sync.
